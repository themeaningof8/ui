  ...
  return (
    <RadioGroupPrimitive.Item
      ...
      className={cn(
        ...
        "focus:outline-none focus-visible:ring-2 focus-visible:ring-step-7 focus-visible:ring-offset-2",
        "disabled:cursor-not-allowed disabled:opacity-50",
        "data-[state=checked]:border-step-6 data-[state=checked]:bg-step-1 data-[state=checked]:text-step-12",
        className
      )}
      {...props}
    >
